...
public class BillServiceImpl implements BillService {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    // FIXED: Get JSONObject instead of String
                    JSONObject jsonObject = jsonArray.getJSONObject(i);
                    addRow(table, HotelUtils.getMapFromJson(jsonObject.toString()));
                }
    ...
    private void addRow(PdfPTable table, Map<String, Object> data) {
        ...
        table.addCell(data.get("quantity").toString()); // Handle different number types
        table.addCell(data.get("price").toString());    // Handle different number types
        table.addCell(data.get("total").toString());    // Handle different number types
    }
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            bill.setProductsDetail((String) requestMap.get("productDetails"));
